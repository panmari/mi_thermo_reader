...
void main() {
  group('ScanTile', () {
    ...
    testWidgets('Parses advertisement data', (tester) async {
      ...
      final temperatureFinder = find.textContaining('Temperature: 23.33°C');
    ...
    testWidgets('Parses advertisement data with fahrenheit unit', (
      tester,
    ) async {
      final scanTile = ScanResultTile(
        result: ScanResult(
      ...
      final humidityFinder = find.textContaining('Humidity: 38.39');
      // 23.33 * 9/5 + 32 = 73.994 -> 73.99°F
      final temperatureFinder = find.textContaining('Temperature: 73.99°F');
      final batteryFinder = find.textContaining('Battery: 92');
